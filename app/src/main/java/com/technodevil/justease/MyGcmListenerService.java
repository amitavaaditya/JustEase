...
public class MyGcmListenerService extends GcmListenerService {
    ...
    public void onMessageReceived(String from, Bundle data) {
        ...
        Log.d(TAG, "Status: " + data.getString(Constants.STATUS));
        ...
        switch (message) {
            ...
            case Constants.ACTION_LOGIN:
                ...
                if(data.getString(Constants.STATUS).equals(Constants.SUCCESS)) {
                    ...
                    Log.d(TAG, "Type: " + data.getString(Constants.USER_TYPE));
                }
                else
            ...
            case Constants.ACTION_ENQUIRY:
                ...
                if(data.getString(Constants.STATUS).equals(Constants.NEW))
                    ...
                    if (data.getString(Constants.STATUS).equals(Constants.SUCCESS)) {
                        ...
                        Log.i("enquiry_id", data.getString(Constants.ENQUIRY_ID));
                    }
                    else
    ...
    private void saveNewMessage(Bundle data) {
        ...
        Log.d(TAG, "saveNewMessage():" + messageDirection);
    ...
    private void sendNotification(Intent intent) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                .setSmallIcon(R.drawable.notf_logo)
