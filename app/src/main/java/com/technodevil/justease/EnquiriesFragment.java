...
public class EnquiriesFragment extends ListFragment {
    ...
    static EnquiryCursorAdapter enquiryCursorAdapter;
    ...
    public void onListItemClick(ListView l, View v, final int position, long id) {
        ...
        Log.d(TAG, "clickedEnquiryID:" + clickedEnquiryID);
    ...
    class ResendTask extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            Log.i(TAG, "Resend Enquiry BroadcastReceiver registered");
        ...
        protected void onPostExecute(Void result) {
            ...
            Log.i(TAG, "Resend Enquiry BroadcastReceiver unregistered");
    ...
    class AcceptEnquiryTask extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            Log.i(TAG, "Accept Enquiry BroadcastReceiver registered");
        ...
        protected void onPostExecute(Void result) {
            ...
            Log.i(TAG, "Accept Enquiry BroadcastReceiver unregistered");
    ...
    class RequestUserInfoTask extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            Log.i(TAG, "Request User Info BroadcastReceiver registered");
        ...
        protected void onPostExecute(Void result) {
            ...
            Log.i(TAG, "Request User Info BroadcastReceiver unregistered");
            Toast.makeText(getActivity(), R.string.enquiry_resend_failure, Toast.LENGTH_SHORT)
                    .show();
        }
    }
        ...
        public void onReceive(Context getActivity, Intent intent) {
            ...
            if(status.equals(Constants.ENQUIRY_RESEND_SUCCESS)) {
                ...
                newEnquiryID = Integer.parseInt(intent.getStringExtra(Constants.NEW_ENQUIRY_ID));
                        Log.d(TAG, "enquiryID:" + Integer.toString(newEnquiryID));
